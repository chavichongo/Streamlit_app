...
with siteHeader:
    ...
    st.markdown('El objetivo de este proyecto es proveer una herramineta que nos permita predecir si una persona ganará más o menos de $50K anuales.')
...
with modelTrain:
    ...
    max_depth = st.slider('¿Cuál es el valor de profundidad para el modelo socio?', min_value = 2, max_value = 10, value = 7, step = 1)
